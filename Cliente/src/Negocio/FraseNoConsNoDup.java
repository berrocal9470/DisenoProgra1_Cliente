 ...
 * @author kathe
 */
public class FraseNoConsNoDup extends Frase{
    ...
    public String generar() {
        ...
        while(resultado.length()<=longitud){
            ...
            for(int i=0;i<=largoPalabra;i++){
                ...
                if(resultado.contains(String.valueOf(alfabeto.charAt(posicion)))) // matches(String.valueOf(alfabeto.charAt(posicion)))){
                    continue;               
                else
